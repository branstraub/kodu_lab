...
jQuery(function($){
	function builder_counter() {
		$('.module.module-counter').each(function(){
			$(this).waypoint(function(){
				...
				new countUp( id, from, to, decimals, 4, { useEasing : true, decimal : '.', prefix : prefix, suffix: suffix } ).start();
	...
	builder_counter();
	$( 'body' ).on( 'builder_load_module_partial', builder_counter );
	$( 'body' ).on( 'builder_toggle_frontend', builder_counter );
});